                                ...
                                if self.end_multicode.is_match(line) {
                                    ...
                                    if !langs.is_empty() {
                                        ...
                                        new_content.push_str(&format!(
                                            r#"<div><select id="select-{example_class_name}" onchange="changeCodeExample('{example_class_name}', event.target.value)" value="{first_lang}" class="code-example" autocomplete="off">"#
                                        ));
                                        ...
                                        // Reset langs and lang_texts for the next code block
                                        langs.clear();
                                        lang_texts.clear();
                                    }
                                    lang_example_no += 1;
